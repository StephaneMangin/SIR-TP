...
public class JpaTest {
    ...
    public void createPersons() {
        ...
        if (numOfPersons != 0) {
            manager.createQuery("DELETE FROM ElectronicDevice");
            manager.createQuery("DELETE FROM Heater");
